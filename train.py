...
from utils.data_loading import BasicDataset, CarvanaDataset, CachedDatset
...
def get_args():
    ...
    parser.add_argument('--num-images', '-n', dest='num_images', type=int, default=None, help='Number of images')
